...
function Checkout() {
    ...
    return (
        ...
        {error ? (<h1>Tekrar Deneyin</h1>):(<h1> </h1>)}
        ...
        <section className="checkout" data-testid="checkout-1">
            <div className="card-body">
                ...
                <div className="card-desp"  data-testid="checkout-details">
                    <h2>Telefon No: {phoneno}</h2>
                    <h2>Fatura Adresi: {address}</h2>
                    <h2>Email: {email}</h2>
                ...
                <h2>Toplam Tutar : {totalamt}</h2>
                </div>
                <button className="submit-bt" onClick={submit}>Sipariş Ver</button>
            </div>
        </section>
        <Footer />
